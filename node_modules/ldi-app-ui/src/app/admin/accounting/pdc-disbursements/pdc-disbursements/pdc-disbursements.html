...
<div class="main-header">
	...
	<a href="/admin/shared/print-pdc-report/start/{{$ctrl.startDate}}/end/{{$ctrl.endDate}}" class="btn btn-primary btn-md button-link">Generate Report</a>
	...
	<a href="/admin/accounting/pdc-disbursement/new" ng-click="" class="btn btn-create btn-md button-link">Create PJV</a>
</div>
					...
					<div class="form-group">
						<div class="horizontal-align -between content">
							<div class="form-group field">
								...
								<input type="text" readonly class="form-control -border" ng-value="$ctrl.pdc.date | date"/>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="side-one">
					<div class="horizontal-align -between content">
						<div class="form-group field">
							...
							<textarea type="text" class="form-control -border" readonly ng-model="$ctrl.pdc.remarks"></textarea>
						</div>
					</div>
				</div>
			</div>
