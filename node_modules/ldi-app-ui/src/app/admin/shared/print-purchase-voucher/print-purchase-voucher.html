<div>
    <div>
        <div>
            <div>
                <h4>Purchase Journal Voucher</h4>
            </div>
            <div>
						...
						<div class="side-one">
							<div class="horizontal-align -between content">
								<div class="form-group field">
									...
									<input type="text" readonly class="form-control -border" ng-value="$ctrl.preparedBy" />
								</div>
								<div class="form-group field">
									<label class="label capitalize-text">Approved By:</label>
									<input type="text" readonly ng-value="$ctrl.approvedBy" class="form-control -border" />
								</div>
								<div class="form-group field">
