	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="wrapper scroll-section">
              ...
              <tbody>
                <tr ng-repeat="mis in $ctrl.misList | filter: {mis.misNo: $ctrl.searchMIS} | orderBy:$ctrl.sortType:$ctrl.sortReverse" data-dismiss="modal" ng-click="$ctrl.selectMIS(mis)">
                  <td>{{mis.misNo}}</td>
                  <td>{{mis.date | date}}</td>
