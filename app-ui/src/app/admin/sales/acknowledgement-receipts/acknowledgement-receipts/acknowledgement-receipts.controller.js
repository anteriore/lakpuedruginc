...
function AcknowledgementReceiptController($state, AcknowledgementReceiptsService, UsersService, $rootScope, $location, _) {
  var ctrl = this;
  ...
  function loadAcknowledgementReceipts(){
	  ...
	  AcknowledgementReceiptsService.listByDepot(ctrl.userAssignedDepot.id).then(function(response){
...
angular
  .module('admin.sales')
  .controller('AcknowledgementReceiptController', AcknowledgementReceiptController);
