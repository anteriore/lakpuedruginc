...
function AcknowledgementReceiptFormController($state, AcknowledgementReceiptsService, OrderSlipsService, SalesInvoicesService, UsersService, SalesSlipsService, $rootScope) {
  var ctrl = this;
  ...
  ctrl.findSalesSlip = function(){
	  SalesSlipsService.listByDepotAndClientAndStatus(ctrl.ar.depot.id, ctrl.ar.client.id, ["Pending","Incomplete"]).then(function(response){
...
angular
  .module('admin.sales')
  .controller('AcknowledgementReceiptFormController', AcknowledgementReceiptFormController);
