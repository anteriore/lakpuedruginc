...
public class ItemData {
	...
	public void init() {
		ItemType rawMaterial = itemTypeRepository.findOne(1L);
		ItemType packagingMaterial = itemTypeRepository.findOne(2L);
		ItemType engineeringMaterial = itemTypeRepository.findOne(3L);
