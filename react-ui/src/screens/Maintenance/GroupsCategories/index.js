        ...
        <Row gutter={[16, 16]}>
          <Col span={10} style={{display: "flex", flexDirection: "column"}}>
            ...
            >
              ...
              <Select placeholder="Select a group" onChange={onSelectGroup} value={selectedGroup !== null ? (selectedGroup.id) : (null)}>
                {groupData.map((group) => (
          ...
          <Col span={10} style={{display: "flex", flexDirection: "column"}}>
            ...
            >
              ...
              <Select placeholder="Select a category" onChange={onSelectCategory} value={selectedCategory !== null ? (selectedCategory.id) : (null)}>
                {selectedGroup.categories !== null && selectedGroup.categories.map((category) => (
