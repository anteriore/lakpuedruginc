...
const InputForm = (props) => {
  ...
  const handleControlNumberChange = useCallback((value) => {
        ...
        <Col span={20} offset={1}>
            {contentLoading ? (
              ...
              <Form form={form} onFinish={onFinish} {...styles.formLayout}>
                <FormItem onFail={onFail} key={_.head(tempFormDetails.form_items).name} item={_.head(tempFormDetails.form_items)}/>
